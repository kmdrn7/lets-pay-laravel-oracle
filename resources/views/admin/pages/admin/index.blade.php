                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="modelTitleId">Tambah Administrator</h4>
                                    </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="modelTitleId">Lihat Administrator</h4>
                                    </div>
                                    <div class="modal-body">
                                        <table class="table table-bordered table-striped">
                                            <tr><td>ID</td><td id="v1"></td></tr>
                                            <tr><td>Nama</td><td id="v2"></td></tr>
                                            <tr><td>Email</td><td id="v3"></td></tr>
                                            <tr><td>Bergabung Pada</td><td id="v4"></td></tr>
                                        </table>
                                    </div>
                                    <div class="modal-footer">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="modelTitleId">Ubah Data Administrator</h4>
                                    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" style="background-color: white; padding: 20px">
                        <h2 class="card-title">Data Administrator</h2>
                        <br>
                        <div class="card-text">
...
@section('script')
    ...
    <script>
        ...
        function submitFormAdd() {
            ...
            $.ajax({
                type: "post",
                url: "/admin/api/v1/insert/administrator",
                data: data,
                dataType: "json",
                success: function ( res ) {
                    if (res.code == 200){
                        ...
                        $('#btnBatal').click()
                        DT.draw()
                        swal('Informasi', 'Sukses menambah data Administrator', 'success');
                    } else {
                        alert('Gagal memasukkan data Administrator baru')
                    }
                }
            });
        }
        ...
        function submitFormUpdate() {
            ...
            $.ajax({
                type: "post",
                url: "/admin/api/v1/update/administrator",
                data: data,
                dataType: "json",
                success: function ( res ) {
                    if (res.code == 200){
                        $('#btnBatalUpd').click()
                        DT.draw()
                        swal('Informasi', 'Sukses mengubah data Administrator', 'success');
                    } else {
                        alert('Gagal mengubah data Administrator baru')
                    }
                }
            });
        }
        ...
        $(document).on('click', '.btn-view', function(){
            ...
            $.ajax({
                type: "get",
                url: "/admin/api/v1/get/administrator",
                data: {
                    id: dis.attr('data-id')
                },
                dataType: "json",
                success: function ( res ) {
                    if (res.code == 200){
                        ...
                        $('#v4').html(res.data.created_at)
                        $('#viewModal').modal('show')
                    } else {
                        alert('Gagal menghapus data Administrator baru')
                    }
                }
            });
        })
        ...
        $(document).on('click', '.btn-update', function(){
            ...
            $.ajax({
                ...
                success: function ( res ) {
                    console.log(res)
                    if (res.code == 200){
                        $('#idUpd').val(res.data.id_admin)
                        $('#namaUpd').val(res.data.nama)
                        $('#emailUpd').val(res.data.email)
                        $('#updateModal').modal('show')
                    } else {
                        alert('Gagal mengambil data Administrator baru')
                    }
                }
            });
        })
        ...
        $(document).on('click', '.btn-delete', function(){
            ...
            swal({
                ...
                if (ret) {
                    $.ajax({
                        type: "post",
                        url: "/admin/api/v1/delete/administrator",
                        data: {
                            id: dis.attr('data-id')
                        },
                        dataType: "json",
                        success: function ( res ) {
                            if (res.code == 200){
                                DT.draw()
                                swal('Informasi', 'Sukses menghapus data Administrator', 'success')
                            } else {
                                alert('Gagal menghapus data Administrator')
                            }
                        }
                    });
                } else {
        ...
        $(function(){
            DT = $('.table-datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '/admin/api/v1/datatable/administrator',
                    data: {
                        table: 'tbl_admin',
                    },
                },
