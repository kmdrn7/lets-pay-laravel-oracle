                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <p>
                                        ...
                                        <textarea class="form-control" name="keterangan" id="keterangan" placeholder="biarkan kosong jika tidak ada keterangan lain" value="" minlength="2" maxlength="150" style="width: 100%; min-height: 100px; max-height: 200px"></textarea>
                                    </p>
                                </div>
                            </div>
                            <div class="row">
